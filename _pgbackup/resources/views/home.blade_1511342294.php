...
<div class="body_content">
    ...
    <div class="quotes">
        ...
        <p>
            ...
            What feels better? You choose.<br>
        </p>   
        <p>Rhonda Byrne</p>
        <hr class="hr_override">
    </div> 
    ...
    <div class="inline">
        <ul>
            <li><a href="https://en.wikipedia.org/wiki/The_Secret_(book)">The Secret</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Rhonda_Byrne">Rhonda Byrne</a></li>
        </ul>
    </div>
</div>{{--body_content--}}
